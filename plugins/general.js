  ...
  async (_0x5cb388, _0x302ad5) => {
    try {
      try {
        ...
        if (!_0x557719) {
          return man.reply("Provide me a query ex Who is Arthur");
        }
...
cmd(
  ...
  async (_0x4e4351) => {
    try {
      ...
      await _0x4e4351.send(util.format(_0x536aa6), {}, "Arthur", _0x680da4);
    } catch (_0x2ee8cc) {
...
cmd(
  ...
  async (_0xbda24) => {
    try {
      ...
      await _0xbda24.send(util.format(_0x3e1ea8.url), {}, "Arthur", _0x7d6de1);
    } catch (_0x1a2f02) {
  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://github.com/Sanji-king/Arthur-Md"
      );
      let _0x1c73f9 = (
        "\nArthur-Md A simple Mutil Device WhatsApp Bot with rich library Created and Managed by *" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
        ...
        "\n  *❲❒❳ Repo:* _https://github.com/Sanji-king/Arthur-Md_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
